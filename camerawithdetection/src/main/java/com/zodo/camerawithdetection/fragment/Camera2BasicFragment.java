...
import com.zodo.camerawithdetection.utils.Utils;
import com.zodo.camerawithdetection.widgets.AutoFitTextureView;
...
//                activity.finish();
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        Log.d("CameraInfo","w: "+w+" ,h: "+h+" ,maxwidth: "+maxWidth+" ,maxheight: "
                +maxHeight+" ,viewwidth: "+textureViewWidth+" ,viewheight: "+textureViewHeight);
        for (Size option : choices) {
            if (option.getWidth() <= maxWidth && option.getHeight() <= maxHeight &&
                    option.getHeight() == option.getWidth() * h / w) {
                Log.d("CameraInfo","option width: "+option.getWidth()+" ,option height: "+option.getHeight());
...
//                }
                ...
                mImageReader = ImageReader.newInstance(largest.getWidth()/3, largest.getHeight()/3,
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            Log.d(TAG,mPreviewSize.getWidth()+" ,"+mPreviewSize.getHeight());
...
//                                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_TARGET_FPS_RANGE,getFPSRange());
    ...
    private Range<Integer> getFPSRange() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O && ranges.length > 0) {
            // 版本低于8.0，使用中间的帧率
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        ...
        Log.d("CameraInfo", "height:"+mPreviewSize.getHeight() + " width: " + mPreviewSize.getWidth());
...
//            mPreviewRequestBuilder.set(CaptureRequest.LENS_FOCUS_DISTANCE, 500.0f);
...
//                    showToast("Saved: " + mFile);
     ...
     * 回传摄像头拍摄的照片
     */
    private static void setIntentResult(){
        cameraCallBack.takePhoto(mBitmap);
    }
